# Marketing, Paid Media, Audiences, and Creative
...
For each approved campaign, record:

- Campaign/vertical and funnel URL
...
- UTM naming
- Optimization event
- Approval status and asset location
- Performance result after enough data exists

Never fabricate client outcomes, testimonials, logos, ROI, or statistics. If proof is limited, use demonstrations, process clarity, substantiated founder expertise, and specific deliverables.

## Apollo and custom audiences

Apollo is part of the prospecting/data workflow for business contact and company records. Potential uses include outbound sequencing, account research, audience matching where permitted, suppression, and seed-audience analysis.
...
- Do not describe matched audiences as a way to guarantee that only owners/partners will see an ad.
...
- Separate lead quantity, qualified-lead rate, booking rate, show rate, opportunity rate, and closed revenue.
- Add value signals later only when grounded in real downstream outcomes.
