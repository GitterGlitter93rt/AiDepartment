...
export const RULES: Rule[] = [
  ...
  { industry: 'garage_door', specialty: 'general', intent: 'general_service',
    anchors: [/\bgarage doors?\b/i,
              ...
              /\b(new|insulated|replacement)\b[^.]{0,15}\bdoor\b[^.]{0,20}\bquote\b/i,
              /\bquote\b[^.]{0,25}\b(new |insulated )+door\b/i],
  ...
  { industry: 'landscaping', specialty: 'general', intent: 'tree_service',
    ...
    veto: [/\btrees?\b[^.]{0,30}\b(roof|house|home|through the)\b/i,
           /\btrees?\b[^.]{0,30}\b(car|truck|vehicle)\b/i,
           /\b(file|start|report)\b[^.]{0,20}\ba claim\b/i] },
  ...
  { industry: 'restoration', specialty: 'general', intent: 'water_damage', urgency: 'emergency',
    ...
    anchors: [/\b(soaked|saturated|waterlogged)\b[^.]{0,40}\b(floor|carpet|drywall|ceiling|wall|everything)\b/i,
              /\b(floor|carpet|drywall|ceiling|walls?)\b[^.]{0,35}\b(soaked|saturated|ruined|destroyed)\b/i,
  ...
  { industry: 'construction', specialty: 'general', intent: 'general_inquiry',
    anchors: [/\b(general )?contractor\b/i, /\bremodel\w*/i, /\brenovat\w+/i, /\bnew (home |house )?construction\b/i, /\bbuild(ing)? a (new )?(house|home)\b/i, /\bbuil[td][- ]?out\b/i, /\bbuil[td]\b[^.]{0,25}\b(commercial|office|retail|warehouse) space\b/i, /\bdeck\b[^.]{0,25}\b(rebuild|rot\w*|replace)\b/i] },
  ...
  { industry: 'pressure_washing', specialty: 'general', intent: 'house_wash',
    anchors: [/\b(siding|exterior|stucco)\b[^.]{0,35}\b(green|black|dirty|mildew|algae|covered in)\b/i,
              /\b(green|black) (stuff|streaks?)\b[^.]{0,25}\b(house|siding|roof|exterior)\b/i],
    support: [/\bwash\w*/i, /\bclean\w*/i] },
  ...
  { industry: 'energy', specialty: 'general', intent: 'project_inquiry',
    anchors: [/\benergy (efficiency|project|audit)\b/i, /\butility (project|program)\b/i, /\b(storage|generation) project\b/i,
              ...
              /\bvendor list\b/i, /\bget on your (vendor|supplier) list\b/i] },
