...
export const RULES: Rule[] = [
  ...
  { industry: 'attorneys', specialty: 'family_law', intent: 'child_custody',
    anchors: [/\bcustody\b/i, /\bvisitation\b/i, /\bparenting (plan|time)\b/i, /\bwho gets the (kids|children)\b/i,
              ...
              /\b(wife|husband|ex|she|he|mother|father)\b[^.]{0,30}\b(took|taken|left with|has)\b[^.]{0,25}\b(the )?(kids|children|son|daughter|them)\b/i,
  ...
  { industry: 'attorneys', specialty: 'criminal_defense', intent: 'criminal_charge',
    anchors: [/\barrested\b/i, /\bcharged with\b/i, /\b(dui|dwi)\b/i,
              /\bd\.? ?u\.? ?i\b/i, /\bd\.? ?w\.? ?i\b/i, /\bfelony\b/i, /\bmisdemean\w+/i, /\bcriminal defense\b/i, /\bwarrant\b/i, /\bin jail\b/i,
  ...
  { industry: 'plumbing', specialty: 'water_heater', intent: 'no_hot_water',
    anchors: [/\bno hot water\b/i,
              /\b(don'?t|dont|do not|haven'?t|havent) (have|got) (any )?hot water\b/i,
              /\bout of hot water\b/i,
              /\bwater heater\b/i, /\bhot water (heater|tank)\b/i, /\bwater (is|isn'?t) (not )?(getting )?hot\b/i],
  ...
  { industry: 'hvac', specialty: 'cooling', intent: 'no_cooling', urgency: 'high',
    anchors: [/\b(a\/?c|air ?condition\w*)\b[^.]{0,40}\b(not work\w*|stopped|broke|down|out|dead|blowing (warm|hot))\b/i,
              ...
              /\b(a\/?c|air ?condition\w*|air condition ?er)\b[^.]{0,25}\b(quit|died|won'?t|wont|will not)\b/i,
              /\b(a\/?c|air ?condition\w*)\b[^.]{0,25}\b(turn on|come on|kick on|start)\b/i],
  ...
  { industry: 'landscaping', specialty: 'general', intent: 'landscape_design',
    anchors: [/\bland ?scap\w+/i, /\bland ?scaper\b/i,
              /\b(paver|outdoor kitchen|fire pit|retaining wall|hardscape)\b/i, /\bsod\b/i],
    support: [/\b(yard|lawn|garden|beds?)\b/i] },
