 ...
 *
 * Carried into V2 from `feature/sales-brain-rep-enrichment`, unchanged: it implements
 * the rule V2 states as an invariant -- no identity on a name alone -- and it was
 * qualified there against sanitized fixtures of real registry pages.
 */
