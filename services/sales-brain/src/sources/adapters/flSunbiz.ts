 ...
 *
 * Carried into V2 from `feature/sales-brain-rep-enrichment`, unchanged. The parsing and
 * mapping halves are what V2 uses; the live lookup stays disabled, because Stage B is
 * gated on a signed source-governance review and nothing here makes a request.
 */
