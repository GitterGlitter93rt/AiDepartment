...
const CARD_TRIGGERS: [string, RegExp][] = [
  ...
  ['who_are_you_again', /\bwho (?:are you|is this|was this|am i (?:speaking|talking) (?:to|with))\b|\bwho'?s (?:this|calling|on the (?:phone|line))\b|say that again|what was your name|which company (?:are you|is this)|what company (?:are you|is this|do you)/i],
  ...
  ['has_receptionist', /\b(?:we|i)\b[^.]{0,20}\b(?:have|got|employ)\b[^.]{0,20}\breceptionists?\b|front desk (?:person|girl|guy|staff)|\bour receptionists?\b|\boffice (?:manager|staff) (?:answers|handles)/i],
